...
from handlers import general_user_router, general_deposit_router, general_subscription_router, neuro_user_router
...
async def start():
    ...
    dispatcher.include_router(neuro_user_router)
